...
req = json.dumps({"id": 1, "scriptName": "managers/commit_manager.py", "payload": {"action": "get_diff", "repo_path": "i:\\Abdullah\\GitHub-Automator", "staged": False}})
p.stdin.write(req + "\n")
p.stdin.flush()
...
start = time.time()
req2 = json.dumps({"id": 2, "scriptName": "managers/commit_manager.py", "payload": {"action": "commit_and_push", "repo_path": "i:\\Abdullah\\GitHub-Automator", "message": "test", "auto_push": False}})
p.stdin.write(req2 + "\n")
p.stdin.flush()
